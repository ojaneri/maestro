...
- **Strategy Pattern**: AI provider switching with fallback sequencing across OpenAI, Gemini, and OpenRouter
...
5. **Meta API Template Management**:
   - Templates created via Meta API endpoints
